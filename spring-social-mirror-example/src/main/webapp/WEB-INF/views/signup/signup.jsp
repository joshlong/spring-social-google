...
<form:form id="signup" action="${pageContext.request.contextPath}/signup" method="post" modelAttribute="signupForm">
    <div class="formInfo">
        <s:bind path="*">
            <c:choose>
    ...
    <fieldset>
        ...
        <form:label path="password">Password (at least 6 characters) <form:errors path="password"
